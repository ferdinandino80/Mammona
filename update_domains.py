import json
import requests
from urllib.parse import urlparsedef get_domains(pastebin_url):
"""
...
:param site_key: Nome del sito per decidere il prefisso.:return: Tuple con l'URL originale e il dominio finale completo.
"""
...
'Tantifilm': general_domains[2],'LordChannel': general_domains[3],
